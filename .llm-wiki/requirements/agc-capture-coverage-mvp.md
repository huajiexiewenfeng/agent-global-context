...
| development | in progress | Capture Core, Source Census, Extractor, manual/incremental Runner, inert Host packaging, activation digests, transactional Windows supervision/optional Hook merge, and the installed Hook latency gate are implemented on `main`; documentation, release verification, and every real-profile gate remain inactive | 2026-08-20 |
| testing | in progress | Phase B full suite: `1215 passed`, one intentional duplicate-ZIP warning. Host Task 3 config+installer: `52 passed`. Host Task 4 latency/Hook/Activation: `35 passed`; latency-specific final: `6 passed`; installed `0.3.0` remains disabled | 2026-08-20 |
