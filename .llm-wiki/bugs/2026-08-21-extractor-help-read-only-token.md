...
- current_gate: implementation and preinstall verification passed.
...
- verification: focused Extractor `48 passed`; adjacent Capture suites `98 passed`; live prepare accepted three ready revisions; first isolated backfill attempted three, completed two, retained one retryable, and reported zero silent loss.
