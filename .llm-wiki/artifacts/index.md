...
| agc-capture-coverage-mvp-design | design | `docs/superpowers/specs/2026-08-13-agent-global-context-high-coverage-capture-design.md` | project | agc-capture-coverage-mvp | pending-review | 2026-08-13 | Phase 1 stops at truthful Receipt plus isolated Collected Observation; no automatic formal-memory mutation. |
